  ...
  <body>
    ...
    <div class="cplgr-listing-search-full-container">
        ...
        <div class="container-fluid">
                ...
                <div class="listinger-search-filter">
                    <div class="row">
                       ...
                       if(isset($liste_partenaire_categories)){
                           ...
                           $nb_partenaire=count($liste_partenaire_categories);
                       }
                       ?>
                        <div class="col-sm-6">
                            <h5 class="result"><?php if(isset($nb_partenaire)) echo $nb_partenaire; ?> résultat(s) pour la catégorie <span>“<?php echo $categorie; ?>”</span></h5>
                        </div>
          ...
          <h5 class="color:green">Nous n'avons aucun partenaire pour cette catégorie pour l'instant , nous sommes en ce moment en négociation avec des partenaires pour vous garantir les meilleures réductions ! </h5>
